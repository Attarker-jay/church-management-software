...
if ($_POST['register_submit']) {
    ...
    $database->query('UPDATE members SET first_name=:first_name,last_name=:last_name,age=:age,group_name=:group_name,country=:country,location=:location,DOB=:DOB,gender=:gender,tel=:tel,email=:email WHERE last_name=:last_name');
...
//Instantiate Database object
    $database = new Database;
//Query
    $database->query('SELECT * FROM members WHERE last_name = :last_name');
    ...
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
        ...
        <main class="page-content">
            <div class="container-fluid">
                ...
                <h3 style="font-variant: small-caps;font-size: 40px; padding-left: 150px"><strong>Edite || Delete
                        Member's Details</strong></h3>
                <hr>
                <p style="font-size: 20px"><b>Please use the form below to change Member's Details<b></p>
                <?php
              if($_GET['page'] == 'delete_membersDetails'){
                  include 'delete_membersDetails.php';
              ...
              if($row){
               ...
               <p class="error">Member ' . ucfirst($search) . ' Details found</p>
               </div>';
           }elseif(!empty($search)){
          ...
          if (!empty($errors)) {
            ...
            echo '<div class="alert alert-success" role="alert">
            <p class="error">Pastor  ' . ucfirst($search) . ' details has been updated!</p>
            </div>';
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="first_name"
                                    ...
                                    placeholder="enter members first-name name"><br />
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="last_name"
                                        ...
                                        placeholder="enter members last-name name"><br />
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="email" class="form-control" name="email"
                                            ...
                                            placeholder="enter members email Address"><br />
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <input type="number" class="form-control" name="age"
                                                value="<?php echo $row['age']; ?>" placeholder=""><br />
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="gender">Select Type Of
                                            Gender:</label>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="date" class="form-control" name="DOB"
                                                    ...
                                                    placeholder="enter pastors date of birth"><br />
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="tel"
                                                        ...
                                                        placeholder="enter members telephone number"><br />
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" name="location"
                                                            ...
                                                            placeholder="enter members location"><br />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <input type="text" class="form-control" name="group_name"
                                                                ...
                                                                placeholder="enter member's group-name"><br />
                                                        </div>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-sm-offset-2 col-sm-10">
                                                            <input
                                                                ...
                                                                type="submit" value="Edite Details"
                                                                name="register_submit" />
                                                            <?php echo '<a href="?page=delete_membersDetails&id='.$row['tel'].'"><span style="background-color: #f44336;font-size: 20px;padding: 12px 35px;color: white;border-radius: 15px">|  Delete Details</span</a>'; ?>
                                                        </div>
                                                    </div>
                                                </div>
