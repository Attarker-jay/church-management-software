...
if (isset($_POST['register_submit'])) {
    ...
    //Query
    $database->query('SELECT email FROM executives WHERE email = :email');
    ...
    if (empty($errors)) {
        //Query
        $database->query('INSERT INTO executives (first_name,last_name,age,gender,location,country,tel,email,ministry)
          VALUES(:first_name,:last_name,:age,:gender,:location,:country,:tel,:email,:ministry)');
        //Bind Values
    ...
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
        ...
        <main class="page-content">
            <div class="container-fluid">
             ...
             <h3 style="font-variant: small-caps;padding-left: 150px;font-size: 40px;"><strong>Register Executives</strong></h3><hr>
             <p style="font-size: 20px"><b>Please use the Form below to register Executives<b></p>
             <?php
             if (!empty($errors)) {
                echo "<ul>";
             ...
             <p class="error">Executive  ' . $last_name . ' is now registered!</p>
             </div>';
         }
         ?>
         ...
         <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div class="form">
             <div class="form-group">
                ...
                <div class="col-sm-1">
                    <input type="number" class="form-control" name="age" value="<?php if ($_POST['age']) echo $_POST['age'] ?>" placeholder="enter pastors age name"><br />
                </div>
            </div>    
             ...
             <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select class="form-control" name="ministry">
                        <option value="<?php if ($_POST['ministry']) echo $_POST['ministry'] ?>"><?php if ($_POST['ministry']) echo $_POST['ministry'] ?></option>
