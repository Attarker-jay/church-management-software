...
if ($_POST['register_submit']) {
    ...
    $database->query('UPDATE tight SET first_name=:first_name,last_name=:last_name,email=:email,location=:location,amount=:amount,tel=:tel,prayer=:prayer WHERE last_name=:last_name');
...
<body style="background-image: url('../img/bg-01.jpg'); background-repeat: no-repeat; background-size: cover;">
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
        ...
        <main class="page-content">
          ...
          <h3 style="font-variant: small-caps;font-size: 40px; padding-left: 150px"><strong>Edit || Delete Tithe Details</strong></h3><hr>
          <p style="font-size: 20px"><b>Please use the form below to change tithe Details<b></p>
          <?php
          if($_GET['page'] == 'deletetightDetails'){
              include 'deletetightDetails.php';
      ...
      if (!empty($errors)) {
        ...
        echo '<div class="alert alert-success" role="alert">
        <p class="error"> ' . $last_name . ' tithe details has been updated!</p>
        </div>';
    ...
    <form class="form-horizontal" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
        ...
        <div class="form">
         <div class="form-group">
            ...
            <div class="col-sm-1">
                <input type="text" class="form-control" name="location" value="<?php echo $row['location']; ?>" placeholder="enter individuals age"><br />
            </div>
        </div>  
        ...
        <div class="form">
         <div class="form-group">
            ...
            <div class="col-sm-4">
                <textarea rows="5" cols="50" class="form-control" name="prayer" value="<?php echo $row['prayer']; ?>" placeholder="Things needed to be prayed for, to manifest in your life"><?php echo $row['prayer']; ?></textarea><br />
            </div>
        </div>  
        ...
        <div class="form">
         <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control" name="tel"  value="<?php echo $row['tel']; ?>" placeholder="enter individuals contact"><br />
            </div>
        </div>  
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              ...
              <?php echo '<a href="?page=deletetightDetails&id='.$row['registered_date'].'"><span style="background-color: #f44336;font-size: 20px;padding: 12px 35px;color: white;border-radius: 15px">|  Delete Details</span</a>'; ?>
          </div>
      </div>
  </div>
